...
cd SEACells && \
python setup.py bdist_wheel --universal && \
cd dist/ && pip install SEACells-0.1.0-py2.py3-none-any.whl --no-deps && \
cd /home/jupyter/ && \
pip install pyparsing==2.4.2 && \
rm -rf dynamo-release/ && rm -rf SEACells/

export NUMBA_CACHE_DIR=/home/jupyter/notebooks/cache/numba_cache
export MPLCONFIGDIR=/home/jupyter/notebooks/cache/matplotlib_cache